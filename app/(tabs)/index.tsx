...
if (!emailAuth || !passwordAuth) return Alert.alert("Chyba", "Vyplňте všechna pole."); 
...
imageStyle={{ opacity: 1 }} // Яскравий фон без зайвої прозорості
> 
...
darkOverlay: { flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.2)' }, // Мінімальне затемнення
